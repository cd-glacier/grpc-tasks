...
import (
	...
	pbActivity "github.com/g-hyoga/grpc-tasks/proto/activity"
	pbProject "github.com/g-hyoga/grpc-tasks/proto/project"
	pbTask "github.com/g-hyoga/grpc-tasks/proto/task"
	"github.com/g-hyoga/grpc-tasks/shared/md"
...
func (s *TaskService) CreateTask(ctx context.Context, req *pbTask.CreateTaskRequest) (*pbTask.CreateTaskResponse, error) {
	...
	resp, err := s.projectClient.FindProject(
		ctx,
	...
	content := &pbActivity.CreateTaskContent{TaskId: task.GetId(), TaskName: task.GetName()}
